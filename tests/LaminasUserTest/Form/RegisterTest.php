...
use LaminasUser\Form\Register as Form;
...
class RegisterTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $options = $this->getMock('LaminasUser\Options\RegistrationOptionsInterface');
    ...
    public function testSetGetRegistrationOptions()
    {
        ...
        $optionsNew = $this->getMock('LaminasUser\Options\RegistrationOptionsInterface');
