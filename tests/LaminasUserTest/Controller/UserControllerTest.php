...
class UserControllerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->redirectCallback = $this->getMockBuilder('LaminasUser\Controller\RedirectCallback')
    ...
    public function setUpLaminasUserAuthenticationPlugin($option)
    {
    ...
    public function testLoginActionValidFormRedirectFalse($isValid, $wantRedirect)
    {
        ...
        $plugin = $this->setUpLaminasUserAuthenticationPlugin(array(
            'hasIdentity'=>false
        ));
        ...
        $form = $this->getMockBuilder('LaminasUser\Form\Login')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        if ($isValid) {
            $adapter = $this->getMock('LaminasUser\Authentication\Adapter\AdapterChain');
    ...
    public function testLoginActionIsNotPost($redirect)
    {
        ...
        $this->assertInstanceOf('LaminasUser\Form\Login', $result['loginForm']);
